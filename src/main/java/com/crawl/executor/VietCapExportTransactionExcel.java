...
public class VietCapExportTransactionExcel {
        ...
        try {
            ...
            for (int j = 0; j < ticketList.size(); j++) {
                ...
                for (VietCapTransactionEntity entity : transList) {
                    ...
                    String MACD_Value = calculateMACD(MACD_array, prevArray, MACD_Days, entity.getClosePrice());
                    ...
                    Object[] extendValueList = new Object[] { entity.getOpenPrice(), entity.getClosePrice(),
                            ...
                            previousAverageLoss != null ? previousAverageLoss.toString() : "N/A", MA_Value, MACD_Value,
                            prevSMA12 != new BigDecimal(0) ? prevSMA12.toString() : "N/A",
    ...
    private static String calculateMACD(Deque<Integer> dequeArray, BigDecimal[] prevArray, Integer dayAmount,
            Integer closedPrice) {
        try {
            /**
