...
public class VietCapTransactionBody {

    private static String query = "query Query($ticker: String!, $offset: Int!, $limit: Int!, $fromDate: String!, $toDate: String!) "
            + "{ " + "TickerPriceHistory( " + "ticker: $ticker " + "offset: $offset " + "limit: $limit "
            + "fromDate: $fromDate " + "toDate: $toDate " + ") { " + "totalRecords " + "history { " + "tradingDate "
            + "priceChange " +
            // "percentPriceChange " +
            "openPrice " + "closePrice " + "highestPrice " + "lowestPrice " + "totalMatchVolume " + "totalMatchValue " +
            // "totalDealVolume " +
            // "totalDealValue " +
    ...
    public static Map<String, Object> get(String inputSymbol, Integer pageNum, Integer recordLimit, String startDate,
        ...
        try {
            if (pageNum > 0) {
                String variable = "{\"ticker\":\"" + inputSymbol + "\",\"limit\": " + recordLimit + ",\"offset\": "
                        + (pageNum - 1) * recordLimit + ",\"fromDate\": " + startDate + ",\"toDate\": " + endDate + "}";
